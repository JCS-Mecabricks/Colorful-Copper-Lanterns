...
public class DarkGrayCopperLantern extends RedCopperLantern {
    public static final MapCodec<DarkGrayCopperLantern> CODEC = createCodec(DarkGrayCopperLantern::new);

    public DarkGrayCopperLantern(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    @Override
    protected DarkGrayCopperLantern.Model createModel(BlockState initialBlockState, ServerWorld world, BlockPos pos) {
    ...
    public static final class Model extends RedCopperLantern.Model {
        public static final ItemStack STANDING_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredCopperLanterns.MOD_ID, "block/dark_gray_copper_lantern"));
        public static final ItemStack HANGING_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredCopperLanterns.MOD_ID, "block/dark_gray_copper_hanging_lantern"));
        public static final ItemStack WALL_MODEL = ItemDisplayElementUtil.getModel(Identifier.of(ColoredCopperLanterns.MOD_ID, "block/dark_gray_copper_wall_lantern"));
