...
public class OrangeCopperLantern extends RedCopperLantern {
    public static final MapCodec<OrangeCopperLantern> CODEC = simpleCodec(OrangeCopperLantern::new);

    public OrangeCopperLantern(BlockBehaviour.Properties settings) {
        super(settings);
    }
    ...
    @Override
    protected OrangeCopperLantern.Model createModel(BlockState initialBlockState, ServerLevel world, BlockPos pos) {
    ...
    public static final class Model extends RedCopperLantern.Model {
        public static final LazyItemStack STANDING_MODEL = ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(ColoredCopperLanterns.MOD_ID, "block/orange_copper_lantern"));
        public static final LazyItemStack HANGING_MODEL = ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(ColoredCopperLanterns.MOD_ID, "block/orange_copper_hanging_lantern"));
        public static final LazyItemStack WALL_MODEL = ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(ColoredCopperLanterns.MOD_ID, "block/orange_copper_wall_lantern"));
