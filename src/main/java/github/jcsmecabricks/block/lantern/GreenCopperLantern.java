...
public class GreenCopperLantern extends RedCopperLantern {
    public static final MapCodec<GreenCopperLantern> CODEC = simpleCodec(GreenCopperLantern::new);

    public GreenCopperLantern(BlockBehaviour.Properties settings) {
        super(settings);
    }
    ...
    @Override
    protected GreenCopperLantern.Model createModel(BlockState initialBlockState, ServerLevel world, BlockPos pos) {
    ...
    public static final class Model extends RedCopperLantern.Model {
        public static final LazyItemStack STANDING_MODEL = ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(ColoredCopperLanterns.MOD_ID, "block/green_copper_lantern"));
        public static final LazyItemStack HANGING_MODEL = ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(ColoredCopperLanterns.MOD_ID, "block/green_copper_hanging_lantern"));
        public static final LazyItemStack WALL_MODEL = ItemDisplayElementUtil.getModel(Identifier.fromNamespaceAndPath(ColoredCopperLanterns.MOD_ID, "block/green_copper_wall_lantern"));
